																	...
																	<?if($bShowButton1):?>
                                                                        ...
                                                                        <div class="smartsearch-field-main">
                                                                            ...
                                                                            <?$APPLICATION->IncludeComponent(
                                                                                ...
                                                                                ".default",
                                                                                Array(
                                                                                    "ANIMATE_HINTS" => array(0=>"",1=>"",),
                                                                                    "ANIMATE_HINTS_SPEED" => "1",
                                                                                    "CATEGORY_0" => array(0=>"iblock_aspro_max_catalog",),
                                                                                    "CATEGORY_0_TITLE" => "",
                                                                                    "CATEGORY_0_iblock_aspro_max_catalog" => array(0=>"26",),
                                                                                    "CHECK_DATES" => "N",
...
<script>
    ...
    function run() {
        let phrases = [
            <?
            $has_cats = false;
            $SectList = CIBlockSection::GetList([], array("IBLOCK_ID" => 26,"ACTIVE"=>"Y"), false, array("ID","NAME"), ["nTopCount" => 10]);
            while ($SectListGet = $SectList->GetNext())
            {
                echo '"'.addslashes($SectListGet["NAME"]).'",';
                $has_cats = true;
            }
            if ($has_cats == false) {
                echo '""';
        ...
        printPhrases(phrases, $('#smart-title-search-input'));
    }
